...
GenericName[hi]=बिट-टोरेंट ग्राहक
...
X-GNOME-FullName[bn]=ট্রান্সমিশন BitTorrent ক্লায়েন্ট
...
X-GNOME-FullName[fi]=Transmission – BitTorrent-sovellus
...
X-GNOME-FullName[hi]=ट्रांसमिशन बिट-टोरेंट ग्राहक
...
X-GNOME-FullName[ky]=Transmission BitTorrent-клиенти
X-GNOME-FullName[li]=Transmission BitTorrent-client
X-GNOME-FullName[lt]=„BitTorrent“ klientinė programa „Transmission“
...
X-GNOME-FullName[te]=ట్రాన్స్‍మిషన్ బిట్ టోరెంట్ క్లయింటు
X-GNOME-FullName[th]=Transmission โปรแกรม BitTorrent
X-GNOME-FullName[tr]=Transmission BitTorrent İstemcisi
X-GNOME-FullName[ug]=Transmission بىتتوررېنت خېرىدارى
...
Comment[fr]=Téléchargement et partage des fichiers via BitTorrent
Comment[gl]=Descargue e comparta ficheiros a través da rede BitTorrent
Comment[he]=הורדה ושיתוף קבצים ברשת ביטורנט
Comment[hi]=बिट-टोरेंट पर संचिका को डाउनलोड तथा साझा करें
...
Comment[nl]=Bestanden binnenhalen en delen via BitTorrent
...
Comment[pt]=Receber e partilhar ficheiros via bittorrent
